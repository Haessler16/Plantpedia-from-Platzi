...
function isIqual(preProps: PlantEntryType, newProps: PlantEntryType) {
  return preProps.plant.plantName === newProps.plant.plantName
}

export const MemoizedPlantEntry = memo(PlantEntry, isIqual)
